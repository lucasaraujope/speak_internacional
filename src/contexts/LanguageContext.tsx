...
export const translations: Translations = {
    ...
    'about.description': { pt: 'Há mais de 20 anos levando fluência em ingles em tempo record de maneira simples e direta, conectando profissionais brasileiiros às melhores oportunidades do mundo.', en: 'For over 20 years delivering English fluency in record time, in a simple and direct way, connecting Brazilian professionals to the best opportunities in the world.', es: 'Durante más de 20 años llevando fluidez en inglés en tiempo récord, de manera simple y directa, conectando a profesionales brasileños con las mejores oportunidades del mundo.', fr: 'Depuis plus de 20 ans, nous apportons la maîtrise de l’anglais en un temps record, de manière simple et directe, en connectant les professionnels brésiliens aux meilleures opportunités du monde.', it: 'Da oltre 20 anni portiamo la fluenza in inglese in tempi record, in modo semplice e diretto, collegando i professionisti brasiliani alle migliori opportunità del mondo.' },
